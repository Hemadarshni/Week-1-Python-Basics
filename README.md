...
Display output using print() and f-strings

Work with basic data types like strings and lists
...
It asks for age, hobby, and favorite food

User inputs are stored in variables

A list is used to store hobbies and food
...
Strings: Handle text input and output
...
Name	Hemadarshni Harikrishnan	Displayed correctly

Age	27	Displayed correctly

Hobby	Badminton	Displayed correctly
...
The program is running in the terminal
...
How to take user input and store data
...
✔ Uses input(), variables, lists, and print()
